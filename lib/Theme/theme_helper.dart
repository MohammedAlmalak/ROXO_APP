...
class ThemeHelper {
  ...
  BoxDecoration buttonBoxDecoration(BuildContext context, [String color1 = "", String color2 = ""]) {
    ...
    if (color1.isEmpty == false) {
      c1 = AppColors.colorFromHex(color1);
    }
    if (color2.isEmpty == false) {
      c2 = AppColors.colorFromHex(color2);
    }
  ...
  ButtonStyle buttonStyle({required double raduis}) {
    return ButtonStyle(
      ...
      backgroundColor: MaterialStateProperty.all(AppColors.activeDotColor),
